...
function retrievePosts(e) {
  ...
  allPosts.fetch({
    ...
    if (posts.length === 0) {
      ...
      posts.forEach(post => {
        p28ResultsArea.innerHTML += (0,_ui_components_gridResult__WEBPACK_IMPORTED_MODULE_4__.gridResult)(post.id, post.title.rendered, post.link, post.acf.affiche_url);
      });
    }
